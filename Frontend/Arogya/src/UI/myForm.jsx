...
const MyForm = ({ handleLocation }) => {
  return (
    <>
      <Form className="w-full max-w-4xl mx-auto p-4 bg-white rounded-lg shadow-lg">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <button
            ...
            className="h-12 px-4 bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 mt-6"
          >
          ...
          />
          <FieldWithLabel name="experience" label="Experience" />
          <FieldWithLabel
