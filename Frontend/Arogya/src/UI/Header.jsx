...
const users = [
  {
    name: "Patient Login",
    description: "Book appointment & get treatment",
    to: "/patient/login",
    icon: faUser,
  },
  {
    name: "Doctor Login",
    description: "Check up patients from your home",
    to: "/doctor/login",
    icon: faUserDoctor,
  },
  {
    name: "Hospital Login",
    description: "Upload patient's reports & bills",
    to: "/",
    icon: faHospital,
  },
  {
    name: "Insurance Company Login",
    description: "Always ready to save your customers life",
    to: "/",
      ...
      >
        <div className="flex lg:flex-1">
          ...
          >
            ...
            <img className="h-8 w-auto float-left" src="/logo.png" alt="" />
          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <img
                ...
                src="https://www.pngkit.com/png/full/113-1133314_logo-for-hospital-management-system-in-png.png"
